...
const TEAM = [
  ...
  },
  {
    ...
    facebook: "https://facebook.com/mandipraut",
    instagram: "https://instagram.com/mandipraut",
    linkedin: "https://linkedin.com/in/mandipraut"
  },
  {
    ...
    facebook: "https://facebook.com/ganeshparajuli",
    instagram: "https://instagram.com/ganeshparajuli",
    linkedin: "https://linkedin.com/in/ganeshparajuli"
  },
  {
    name: "Binod Chalise",
    ...
    facebook: "https://facebook.com/binodchalise",
    instagram: "https://instagram.com/binodchalise",
    linkedin: "https://linkedin.com/in/binodchalise"
  }
]
  ...
  return (
    <>
      <div className="bg-gradient-to-b from-blue-50 to-white min-h-screen">
        ...
        {/* Combined Founder Message Section */}
        <section className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Discover the passion and vision behind Langzy's mission to transform language learning worldwide.
            </p>
          </div>

          {/* Main Content - Text + Video Layout */}
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-100">
              <div className="flex items-center gap-6 mb-6">
                <img
                  src={founderImg}
                  alt="Ashok Dhungana"
                  className="w-20 h-20 rounded-full object-cover border-3 border-blue-300 shadow-lg flex-shrink-0"
                />
                <div>
                  <h3 className="text-2xl font-bold text-blue-900">Ashok Dhungana</h3>
                  <p className="text-lg text-blue-700 font-medium">Founder & CEO</p>
                </div>
              </div>

              
                <blockquote className="text-lg text-gray-700 leading-relaxed mb-6 italic">
                  "At Langzy, we believe that language is the bridge to new opportunities and friendships. Our mission is to empower you to grow your words and expand your world. 
                  <br /><br />
                  Every student who joins our community becomes part of a global family where cultural barriers dissolve and meaningful connections flourish. Thank you for being part of our journey!"
                </blockquote>
                
                <div className="border-t border-gray-200 pt-6">
                  <p className="text-gray-600 mb-4">Connect with our founder:</p>
                  <div className="flex gap-4">
                    <a
                      href="https://facebook.com/ashokdhungana"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-blue-600 hover:text-blue-800 transition-colors bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-pink-600 hover:text-pink-800 transition-colors bg-pink-50 hover:bg-pink-100 px-4 py-2 rounded-lg"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 text-blue-700 hover:text-blue-900 transition-colors bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-black">
                ...
                >
                  ...
                  <source src="/videos/founder-message.webm" type="video/webm" />
              ...
              <div className="text-center mt-4">
                <p className="text-gray-600 text-sm">
                  Watch our founder share his personal journey and vision for Langzy
                </p>
              </div>
            </div>
          </div>
