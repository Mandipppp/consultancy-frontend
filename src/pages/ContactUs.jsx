    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div className="min-h-[calc(100vh-80px)] flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 relative overflow-hidden flex flex-col justify-center">
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-4 sm:top-8 left-4 sm:left-8 w-8 sm:w-16 h-8 sm:h-16 bg-white rounded-full"></div>
              <div className="absolute top-16 sm:top-32 right-8 sm:right-16 w-6 sm:w-12 h-6 sm:h-12 bg-white rounded-full"></div>
              <div className="absolute bottom-8 sm:bottom-16 left-8 sm:left-16 w-5 sm:w-10 h-5 sm:h-10 bg-white rounded-full"></div>
              <div className="absolute bottom-16 sm:bottom-32 right-4 sm:right-8 w-9 sm:w-18 h-9 sm:h-18 bg-white rounded-full"></div>
            </div>
            
            <div className="relative z-10 text-white px-4 sm:px-6 py-6 sm:py-4 mx-2 sm:mx-4 my-2">
              {/* Header */}
              <div className="text-center mb-4 sm:mb-5">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                  Get in Touch
                </h1>
                <p className="text-blue-100 text-sm sm:text-base leading-relaxed max-w-sm mx-auto">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-5">
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-2 sm:p-3 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="text-lg sm:text-xl font-bold text-white mb-1">10,000+</div>
                  <div className="text-blue-200 text-xs">Happy Students</div>
                </div>
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-2 sm:p-3 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="text-lg sm:text-xl font-bold text-white mb-1">25+</div>
                ...
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-2 sm:p-3 text-center border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="text-lg sm:text-xl font-bold text-white mb-1">95%</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  <div className="flex items-center">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white text-sm font-semibold break-all">{loadingInfo ? 'Loading...' : contactInfo.email}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      required
                      className="w-full h-20 sm:h-24 border-2 border-gray-200 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:outline-none transition-colors resize-none"
